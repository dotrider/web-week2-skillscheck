...
// console.log(ilove("pablo","music"));

// console.log(ilove(hello,yo))
//////////////////PROBLEM 8////////////////////
...
//(this means your counter should decrement), and then add each item to the 'reversed' array variable you created. Finally, 
//return the 'reversed' array variable. 
...
var doubled = myNumbers.map(num => num * 2);
...
// Code Here
var filtered = myNumbers.filter(num => num > 100);
//////////////////PROBLEM 16////////////////////
...
// Code Here
var total = myNumbers.reduce((total, nums) => nums + total)
// console.log(total);
//////////////////PROBLEM 17////////////////////
...
// Code Here
var forTheLoveOfGeorge = notGeorge.map(name => name = 'George' );
...
// Code Here
var enemies = people.filter(name => name.friend === false)
// console.log(enemies)
//////////////////PROBLEM 20////////////////////
