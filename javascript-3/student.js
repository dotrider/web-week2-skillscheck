...
// Code Here
var groceries = ['oranges', 'bananas', 'apples'];
...
// console.log(setGroceryListTitle(x))
//////////////////STEP 4////////////////////
...
//invoke displayData() which is a function you did not create (we did) 
...
function checkGroceryCount(){
    for(let i = 0; i < groceries.length; i++){
        ...
        else if(groceries[i] >= 1 && groceries <= 5){
        }
