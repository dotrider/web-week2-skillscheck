...
// CODE HERE
var faveColors = ['blue','red','orange']
...
let me = {
    ...
    homeTown: 'Gothem City',
    superPowers: ['Speed', 'x-ray vision', 'Strength'],
    superPowerXP: function(){
        return Math.floor(Math.random() * 100) + 1;
    },
    profileImage: new URl(`https://randomuser.me/api/portraits/med/lego/.jpg`)
}
//////////////////Step 3////////////////////
...
//Now, imagine your super hero needs to go undercover, and you need to remove all info about them. That is what this function will do. 
